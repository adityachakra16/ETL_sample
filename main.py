...
if __name__ == "__main__":
    ...
    tasks = {"Setup":
              {"Therapy": {"table_name" : "Therapy",
                           "columns": ["uniqueid SERIAL NOT NULL", "primaryid NUMERIC(1000) NOT NULL", "caseid NUMERIC(500) NOT NULL",
                                          ...
                                          "dur NUMERIC(150)", "dur_cod VARCHAR(500)"],
                           "primary_key": ["uniqueid"],
                           "foreign_key": ["(primaryid, dsg_drug_seq) REFERENCES Drug(primaryid, drug_seq)"],
                           "unique": []
              },
              "Indication": {"table_name" : "Indication",
                               ...
                               "primary_key": ["uniqueid"],
                               "foreign_key": ["(primaryid, indi_drug_seq) REFERENCES Drug(primaryid, drug_seq)"],
                               "unique" : []
    ...
    #setup = DBSetup(tasks["Setup"])
    stage = Stage("fda", "Reaction")
